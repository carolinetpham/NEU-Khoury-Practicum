  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? 'bg-white/70 shadow-[0_8px_30px_rgba(0,0,0,0.06)] backdrop-blur-xl'
          : 'bg-transparent',
      )}
    >
      <nav
      ...
      >
        ...
        <div
          ref={containerRef}
          className={cn(
            'relative hidden items-center gap-0.5 rounded-full border border-black/10 bg-white/82 p-1 backdrop-blur-md md:flex',
            scrolled && 'shadow-sm',
          )}
        >
          {indicator && (
